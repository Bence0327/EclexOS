...
$url = "https://raw.githubusercontent.com/Bence0327/EclexOS/refs/heads/main/System_config_scripts/Lockscreen_uninstall.ps1"

# Giving the place and name to download the script
$filename = "I don't want EclexOS's lockscreen.ps1"
