...
while (-not $InstallerRunning) {
    ...
    if ($ProcessList) {
        ...
        Write-Host "Installer has been started, waiting for 10 second to continue..."
        Start-Sleep -Seconds 10

        [Keyboard]::PressKey(0x5B)
        Start-Sleep -Seconds 2
    } else {
        Write-Host "The installer isn't running yet, checking it in 10 seconds..."
        Start-Sleep -Seconds 10
    }
}
...
Write-Host "Rockstar Games Launcher installed sucsesfully!"
...
Write-Host "Roblox installed sucsesfully!"
...
Write-Host "Epic Games Launcher installed sucsesfully!"
...
Write-Host "Steam installed sucsesfully!"
...
Write-Host "EA app installed sucsesfully!"
...
Write-Host "OBS Studio installed sucsesfully!"
