...
$RockstarProcess = Get-Process | Where-Object { $_.MainWindowTitle -eq $WindowTitle } | Select-Object -First 1
$RockstarProcess -and $RockstarProcess.MainWindowHandle -ne [IntPtr]::Zero
[WinAPI]::SetForegroundWindow($RockstarProcess.MainWindowHandle)
 Start-Sleep -Seconds 2
